...
const base = {
    ...
    devServer: {
        ...
        // TwT反馈 AI 审核：当从 localhost 访问时，Pollinations 会因 Origin=localhost
        // 触发 Cloudflare Turnstile 拦截（403 Missing Turnstile token）。
        // 这里由 dev-server 服务端转发，并删除 origin/referer 头绕过该限制。
        // 生产环境（真实域名）直连即可，无需代理。
        proxy: {
            '/tw-ai-proxy': {
