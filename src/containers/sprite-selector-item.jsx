...
class SpriteSelectorItem extends React.PureComponent {
    ...
    handleLayerManager (e) {
        e.stopPropagation();
        this.props.onLayerManagerButtonClick(this.props.id);
    }
    handleMouseLeave () {
    ...
    render () {
        ...
        return (
            <SpriteSelectorItemComponent
                ...
                onLayerManagerClick={onLayerManagerButtonClick ? this.handleLayerManager : null}
...
SpriteSelectorItem.propTypes = {
    ...
    onLayerManagerButtonClick: PropTypes.func,
