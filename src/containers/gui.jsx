...
const mapStateToProps = state => {
    ...
    return {
        ...
        codeLibraryModalVisible: state.scratchGui.modals.codeLibraryModal,
        customModalVisible: state.scratchGui.modals.customModal,
...
const mapDispatchToProps = dispatch => ({
    ...
    onRequestCloseCustomModal: () => dispatch(closeCustomModal()),
