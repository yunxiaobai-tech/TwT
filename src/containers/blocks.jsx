    ...
    componentDidUpdate (prevProps) {
        ...
        if (this.props.isVisible === prevProps.isVisible) {
            if (
                ...
                // Use RAF loop to smoothly resize Blockly during stage transition
                cancelAnimationFrame(this._stageSizeRafId);
                clearTimeout(this._stageSizeResizeTimeout);
                ...
                const animate = (now) => {
                    ...
                    if (now - start < duration) {
                        this._stageSizeRafId = requestAnimationFrame(animate);
                    }
                };
                this._stageSizeRafId = requestAnimationFrame(animate);
            }
