...
const SET_CENTER_MENU_BAR = 'tw/SET_CENTER_MENU_BAR';
const SET_COMPATIBLE_SVG = 'tw/SET_COMPATIBLE_SVG';
const SET_CONSOLIDATE_FEATURES = 'tw/SET_CONSOLIDATE_FEATURES';
...
const reducer = function (state, action) {
    ...
    case SET_CENTER_MENU_BAR:
        return Object.assign({}, state, {
            centerMenuBar: action.centerMenuBar
        });
    case SET_COMPATIBLE_SVG:
        return Object.assign({}, state, {
            compatibleSvg: action.compatibleSvg
        });
    case SET_CONSOLIDATE_FEATURES:
        return Object.assign({}, state, {
            consolidateFeatures: action.consolidateFeatures
        });
    default:
        return state;
    }
...
const setCenterMenuBar = function (centerMenuBar) {
    return {
        type: SET_CENTER_MENU_BAR,
        centerMenuBar
    };
};

const setCompatibleSvg = function (compatibleSvg) {
    return {
        type: SET_COMPATIBLE_SVG,
        compatibleSvg
    };
};

const setConsolidateFeatures = function (consolidateFeatures) {
    return {
        type: SET_CONSOLIDATE_FEATURES,
        consolidateFeatures
    };
};
