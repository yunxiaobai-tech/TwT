...
import TWCustomModal from '../../containers/tw-custom-modal.jsx';
import TWFeedbackModal from '../../containers/tw-feedback-modal.jsx';
    ...
    return (<MediaQuery minWidth={unconstrainedWidth}>{isUnconstrained => {
        ...
        const alwaysEnabledModals = (
            <React.Fragment>
                ...
                {customModalVisible && <TWCustomModal onClose={onRequestCloseCustomModal} />}
                {feedbackModalVisible && <TWFeedbackModal onClose={onRequestCloseFeedbackModal} />}
            </React.Fragment>
        );
