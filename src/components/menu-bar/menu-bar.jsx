        ...
        const menuBar = (
            ...
            >
                <div className={styles.mainMenu}>
                        ...
                        {(this.props.canManageFiles) && (
                            ...
                            >
                                ...
                                >
                                    ...
                                    {this.props.consolidateFeatures && (
                                        <MenuSection>
                                            <MenuItem onClick={this.handleClickRename}>
                                                <FormattedMessage
                                                    defaultMessage="Rename"
                                                    description="Menu bar item to rename project"
                                                    id="tw.menuBar.rename"
                                                />
                                            </MenuItem>
                                        </MenuSection>
                                    )}
                    ...
                    {!this.props.consolidateFeatures && (this.props.canEditTitle ? (
...
MenuBar.propTypes = {
    ...
    onSetConsolidateFeatures: PropTypes.func,
...
const mapDispatchToProps = dispatch => ({
    ...
    onSetConsolidateFeatures: value => dispatch(setConsolidateFeatures(value)),
