...
import ProfileCenterModal from '../tw-profile-center-modal/profile-center-modal.jsx';
import Modal from '../../containers/modal.jsx';

import {openTipsLibrary, openSettingsModal, openRestorePointModal, openCustomModal, openFeedbackModal} from '../../reducers/modals';
import {setPlayer} from '../../reducers/mode';
import {setCenterMenuBar} from '../../reducers/tw';
...
import brushIcon from './tw-brush.svg';
...
const twMessages = defineMessages({
    ...
    profileCenter: {
        ...
        defaultMessage: 'Profile Center',
        description: 'Title of the profile center modal'
    },
    profileCenterPlaceholder: {
        id: 'tw.menuBar.profileCenterPlaceholder',
        defaultMessage: 'Profile center placeholder',
        description: 'Placeholder text in the profile center modal'
    },
    profileCenterTitle: {
        id: 'tw.menuBar.profileCenterTitle',
        defaultMessage: 'TwT Profile Center',
        description: 'Title of the profile center modal'
    }
});
...
class MenuBar extends React.Component {
    ...
    componentDidMount () {
        ...
        // 开发用：按下 P 键直接打开个人中心弹窗（跳过登录判断）
        document.addEventListener('keydown', this.handleDevProfileKey);
    }
    componentWillUnmount () {
        document.removeEventListener('keydown', this.handleKeyPress);
        document.removeEventListener('keydown', this.handleDevProfileKey);
    }
    handleDevProfileKey (e) {
        // 仅开发用：仅响应单独的 'p' 键，避免与输入框/组合键冲突
        if (e.key !== 'p' && e.key !== 'P') return;
        if (e.ctrlKey || e.metaKey || e.altKey) return;
        const tag = (e.target && e.target.tagName) || '';
        if (tag === 'INPUT' || tag === 'TEXTAREA' || (e.target && e.target.isContentEditable)) return;
        if (this.state.profileModalOpen) return;
    ...
    handleClickRename () {
        ...
        const newTitle = prompt(this.props.intl.formatMessage({
            defaultMessage: 'Rename project',
            description: 'Prompt for renaming project',
            id: 'tw.menuBar.renameProject'
        }), this.props.projectTitle);
        if (newTitle !== null && newTitle.trim() !== '') {
            this.props.onSetProjectTitle(newTitle.trim());
        }
    }
        ...
        const menuBar = (
            <Box
                className={classNames(
                    ...
                    styles.menuBar,
                    {
                        [styles.centerMenuBar]: this.props.centerMenuBar
                    }
                )}
            >
                <div className={styles.mainMenu}>
                    <div className={styles.fileGroup}>
                        {this.props.errors.length > 0 && <div>
                            ...
                            >
                                ...
                                >
                                    <MenuSection>
                                        <MenuItemLink href="https://github.com/TurboWarp/scratch-gui/issues">
                                            <FormattedMessage
                        ...
                        <div
                            className={classNames(styles.menuBarItem, styles.hoverable)}
                            onClick={this.props.onClickCustomModal}
                        >
                            <img
                                src={brushIcon}
                                draggable={false}
                            ...
                            <span className={styles.collapsibleLabel}>
                                <FormattedMessage
                                    ...
                                    description="Menu bar button to open personalization settings"
                    ...
                    <div className={styles.menuBarItem}>
                        <Button
                            ...
                            onClick={this.props.onClickFeedbackModal}
                        >
                            <FormattedMessage
                ...
                <div className={styles.accountInfoGroup}>
                    <TWSaveStatus
                        ...
                        onClickProfile={this.handleOpenProfileModal}
                    />
                </div>
        ...
        return (
            <React.Fragment>
                ...
                {this.props.loginMenuOpen ? (
                    <LoginModal
                        lang={this.props.currentLocale && this.props.currentLocale.startsWith('zh') ? 'zh' : 'en'}
                ...
                {this.state.profileModalOpen ? (
                    <Modal
                        ...
                        id="profile-center"
                        onRequestClose={this.handleCloseProfileModal}
                        contentLabel={this.props.intl.formatMessage(twMessages.profileCenterTitle)}
                    >
                        <ProfileCenterModal
...
MenuBar.propTypes = {
    ...
    onClickCustomModal: PropTypes.func,
    onClickFeedbackModal: PropTypes.func,
    ...
    onSetCenterMenuBar: PropTypes.func,
...
const mapDispatchToProps = dispatch => ({
    ...
    onSetCenterMenuBar: value => dispatch(setCenterMenuBar(value)),
