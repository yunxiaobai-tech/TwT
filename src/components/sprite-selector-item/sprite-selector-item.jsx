...
const SpriteSelectorItem = props => (
    ...
    >
        ...
        {props.onDuplicateButtonClick || props.onDeleteButtonClick || props.onExportButtonClick || props.onLayerManagerClick ? (
            <ContextMenu id={`${props.name}-${contextMenuId++}`}>
                ...
                {props.onLayerManagerClick ? (
                    <MenuItem onClick={props.onLayerManagerClick}>
                        <FormattedMessage
                            defaultMessage="layer manager"
                            description="Menu item to open the layer manager for the sprite"
                            id="tw.spriteSelectorItem.layerManager"
                        />
                    </MenuItem>
                ) : null}
...
SpriteSelectorItem.propTypes = {
    ...
    onLayerManagerClick: PropTypes.func,
