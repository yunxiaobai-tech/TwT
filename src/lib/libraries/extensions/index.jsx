...
import audioCodecIcon from './twt/audio-codec-icon.svg';
...
export default [
    ...
    '---',  // ✅ 分隔线移到 TwT 扩展前面
    {
        name: (
            <FormattedMessage
                defaultMessage="音频编码器"
                description="Name for the Audio Codec extension"
                id="gui.extension.audioCodec.name"
            />
        ),
        extensionId: 'audioCodecPro',
        extensionURL: 'https://earnest-dango-2c055f.netlify.app/audio-codec.js',
        iconURL: audioCodecIcon,
        description: (
            <FormattedMessage
                defaultMessage="将你的声音用文本储存。"
                description="Description for the Audio Codec extension"
                id="gui.extension.audioCodec.description"
            />
        ),
        tags: ['twt'],
        featured: true,
        ...
        credits: [
            <a
                href="https://space.bilibili.com/541080936"
                target="_blank"
                rel="noreferrer"
                key="author"
            >
